...
Add following line on PVE host at the end of /etc/pve/lxc/<lxcid>.conf. This will create a new host:lxc shared group to which devices can be added to for read-write permission from within LXC:
```
